const Experience = () => {
    return (
        <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Work & Experience
            </h3>
            <div className="flex mt-4">
                ...
                <div className="flex-grow ml-4 mb-10">
                    ...
                    <div className="text-gray-950 font-bold">Product Manager
                    </div>
                    <div className="text-green-600">AGB Company
                    </div>
            ...
            <div className="flex ">
                ...
                <div className="flex-grow ml-4">
                    ...
                    <div className="text-gray-950 font-bold">Marketing Manager
                    </div>
                    <div className="text-green-600">AB Company
